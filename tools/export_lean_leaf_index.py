...
def main() -> None:
    ...
    roles = {
        ...
        "QuantumBlockEncoding/ConcreteSemantics.lean": "finite state action and product-register bridges",
    ...
    lines.append("")
    lines.append("External Lean libraries are indexed as memory cards rather than")
    ...
    lines.append("- `research-wiki/external-lean-libraries/atlas-lean.md`")
