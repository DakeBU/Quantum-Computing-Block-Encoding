...
| Preset | Purpose |
| --- | --- |
| `main_case_hierarchical_reproduction.md` | Current public preset for the transfer-operator main case.  It runs two isolated Hierarchical Harness arms: no-Pro and Pro-insight. |
