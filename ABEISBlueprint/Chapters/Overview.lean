...
currently records 1,646 explicit public definitions, abbreviations, opaque declarations,
inductive types, structures, classes, theorems, and lemmas in the Lean source. It also records
177 private declarations as deliberate exclusions. Of the public declarations, 1,299 carry
source docstrings; all 1,646 receive a generated reader cue, formal-status note, source preview,
and catalog assignment in the Library Explorer. Structure-generated projections are accessible
through their parent structure but are not double-counted as source declarations.
