...
normalizer, resource counts, and proof obligations.  The next backend target is
to define the full matrix semantics of \(U\) and the block-projection map.
...
\begin{enumerate}
  ...
  \item define the signal/system block projection;
