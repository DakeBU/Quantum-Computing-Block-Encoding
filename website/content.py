...
LESSONS = {
    ...
    "certified-cases": {
        ...
        "sections": [
            ...
            ("From one-term operators to the Hamiltonian", r"A=\sum_kA_k,\quad A^\dagger=\sum_kA_k^\dagger,\quad H=S_1\otimes x_\xi+S_2\otimes I_\xi.", "The paper itself carries this composition through Theorem 4. ASPBE compiles the same A/A-dagger, S1/S2, and H chain and also checks the LCU filler phases rather than treating the displayed matrix equality as self-evident."),
