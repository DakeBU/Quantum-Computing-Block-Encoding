...
LESSONS = {
    ...
    "certified-cases": {
        ...
        "sections": [
            ...
            ("From one-term operators to the Hamiltonian", r"A=\sum_kA_k,\quad A^\dagger=\sum_kA_k^\dagger,\quad H=S_1\otimes x_\xi+S_2\otimes I_\xi.", "The paper itself carries this composition through Theorem 4. ASPBE now compiles the same source-level A/A-dagger, S1/S2, and H chain in GHLHamiltonian.lean."),
