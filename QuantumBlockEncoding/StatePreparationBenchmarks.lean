import QuantumBlockEncoding.StatePreparationBenchmarksCore
...
* `StatePreparationBenchmarksCore` contains exact finite target, normalization,
  unitarity, and state-action certificates plus paper resource arithmetic.
