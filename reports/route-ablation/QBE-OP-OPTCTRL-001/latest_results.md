...
| `20260619-115255-reference_qiskit` | `reference_qiskit` | checker-baseline | failed |  | 0.169 | False | n/a | finite Qiskit Operator equality |
| `20260619-115325-reference_qiskit` | `reference_qiskit` | checker-baseline | passed |  | 0.296 | True | n/a | finite Qiskit Operator equality |
